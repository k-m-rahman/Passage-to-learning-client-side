...
const Home = () => {
  ...
  return (
    <div>
      ...
      {/* courses list */}
      <div className="m-5 p-5 border border-slate-300 rounded-lg box-shadow pb-16 bg-zinc-50 flex flex-col gap-5 justify-center items-center mt-10">
      ...
      {/* instructors list */}
      <div className="m-5 p-5 border border-slate-300 rounded-lg box-shadow pb-16 bg-zinc-50 flex flex-col gap-5 justify-center items-center mt-10">
        <h2 className="text-3xl md:text-5xl font-bold mb-5">Our Instructors</h2>
